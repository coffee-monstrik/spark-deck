...
## Step 1: Define deck data model and assets
...
## Step 2: Game state store and persistence
- Create a client-side game store (React context + reducer) holding players, selected deck copy, current player, drawn categories (initial 4), current card, answered count, action log, and flags for winning/stop states.
...
## Step 3: Routing, guards, and layout
